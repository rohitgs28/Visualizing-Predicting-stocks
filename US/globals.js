...
monthWidth=(innerRadius*2)-250;
// monthWidth = (outerRadius * 2);

var iText, iChords, eText, eChords;

var angleRange = 320,
// monthOffset=(monthWidth)/(maxYear*12+maxMonth),
// monthOffset = (maxYear * maxMonth) / monthWidth,
monthOffset = 3,
countries,
e_labels = [],
e_chords = [],
...
// .text("* Cumulative volume since "+baseYear)
.text("* Highest opening price")
.style("font-size", "0px");
